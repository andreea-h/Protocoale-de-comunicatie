...
int main(int argc, char *argv[])
{
    ...
    char *new_cookie = (char *)malloc(500 * sizeof(char));
    strcpy(new_cookie, key);
    strcat(new_cookie, ":");
    strcat(new_cookie, value);

    printf("Cookie: %s\n", new_cookie);
    message = compute_get_request(new_addr, dummy_weather, NULL, &new_cookie, 1);
